<title>Edudigm || Answer Key</title>
...
<div class="container my-5">
    <div class="row justify-content-center">
        <h2 class="col-md-12 text-center mb-4 text-uppercase font-weight-bold ">Answer Keys</h2>
        <div class="col-md-6">
            <div class="card p-5">
...
<script>
    ...
    $('.user_details_submit').click(function() {
        ...
        if(name && stu_class && exm_code){
            var response=ans_key_save_user_info(mobile, name, stu_class,exm_code,"NA");
            $("#drp_dwn_class").prop('disabled', true);
                $("#user_name").prop('disabled', true);
            if(response.response_code==200){
